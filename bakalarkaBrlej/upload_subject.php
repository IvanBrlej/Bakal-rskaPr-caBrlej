...
$query = $con->prepare("SELECT subject FROM subjects WHERE username = '$userLoggedIn'");
$query->execute();
...
<div class="container" style="margin-top: 60px" align="center">
    ...
    <form id="indexFrom" method="post" action="selectQuestionType.php" name="uploadSubjectForm">
